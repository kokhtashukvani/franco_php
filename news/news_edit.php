...
$stmt = $conn->prepare("SELECT title, description, is_show FROM news WHERE id = ?");
    ...
    <div class="wrapper">
        ...
        <main class="col-md-10 ms-sm-auto content">
            ...
            <div class="card p-4 mt-3">
                <form action="news_update.php" class="card-body" method="post">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="mb-3">
                        <label class="form-label" for="title">عنوان</label>
                        <input class="form-control" id="title" name="title" type="text" value="<?php echo htmlspecialchars($news['title']); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="description">شرح</label>
                        <textarea class="form-control" cols="50" id="description" name="description" rows="6"><?php echo htmlspecialchars($news['description']); ?></textarea>
                    </div>
                    <div class="mb-3 form-check">
                        <input class="form-check-input" id="is_show" name="is_show" type="checkbox" value="1" <?php echo $news['is_show'] ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="is_show">نمایش/عدم نمایش</label>
                    </div>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> ثبت</button>
                    <a href="news_list.php" class="btn btn-warning"><i class="fa fa-times"></i> انصراف</a>
                </form>
            </div>
        </main>
    </div>
