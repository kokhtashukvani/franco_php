...
$sql = "SELECT id, title, release_date, is_show, display_order FROM announcements ORDER BY display_order ASC";
        ...
        <main class="col-md-10 ms-sm-auto content">
            ...
            <div class="card p-4 mt-3">
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <div class="btn-group">
                        <a class="btn btn-primary" href="announcement_add.php"><i class="fa fa-plus"></i> ایجاد جدید</a>
                    </div>
                ...
                <div id="crudTableContainer" class="table-responsive">
                    ...
                    <table id="crudTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr data-id="<?php echo $row['id']; ?>">
                                        ...
                                        <td class="text-center"><?php echo htmlspecialchars($row['release_date']); ?></td>
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-primary" href="announcement_edit.php?id=<?php echo $row['id']; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="announcement_delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این رکورد مطمئن هستید؟');">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="text-center">هیچ اطلاعیه‌ای یافت نشد.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                    ...
                    <script>
                        ...
                        $("#saveOrderBtn").on("click", function () {
                            ...
                            $.ajax({
                                url: 'announcement_update_order.php', // Updated URL
                                type: "POST",
