...
$sql = "SELECT id, store_name, first_name, last_name, phone, mobile, display_order FROM dealers ORDER BY display_order ASC";
    ...
    <div class="wrapper">
        ...
        <main class="col-md-10 ms-sm-auto content">
            <header class="d-flex justify-content-between align-items-center mb-3">
                <h5>مدیریت نمایندگی ها &gt; لیست نمایندگان ثبت شده در سیستم</h5>
            ...
            <div class="card p-4 mt-3">
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <a class="btn btn-primary" href="dealer_add.php"><i class="fa fa-plus"></i> ایجاد جدید</a>
                    <button class="btn btn-secondary" onclick="location.reload();"><i class="fa fa-sync"></i> بارگذاری مجدد لیست</button>
                    <button class="btn btn-success btn-sm" id="saveOrderBtn"><i class="fa fa-save"></i> ذخیره ترتیب</button>
                </div>

                <div class="table-responsive" id="crudTableContainer">
                    ...
                    <table id="crudTable" class="table table-bordered table-striped">
                        <thead class="table-header" style="background:#5986b3 !important">
                            <tr>
                                <th style="text-align:center; vertical-align:middle">نام فروشگاه</th>
                                <th style="text-align:center; vertical-align:middle">نام</th>
                                <th style="text-align:center; vertical-align:middle">نام خانوادگی</th>
                                <th style="text-align:center; vertical-align:middle">تلفن</th>
                                <th style="text-align:center; vertical-align:middle">تلفن همراه</th>
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr data-id="<?php echo $row['id']; ?>">
                                        ...
                                        <td class="text-center"><?php echo htmlspecialchars($row['store_name']); ?></td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-primary" href="dealer_edit.php?id=<?php echo $row['id']; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="dealer_delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این رکورد مطمئن هستید؟');">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center">هیچ نماینده‌ای یافت نشد.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                    ...
                    <script>
                        ...
                        $("#saveOrderBtn").on("click", function () {
                            ...
                            $.ajax({
                                url: 'dealer_update_order.php',
                                type: "POST",
                                contentType: "application/json",
                                data: JSON.stringify(order),
                                success: function (response) {
                                    console.log(response);
                                    window.location.href = 'dealer_list.php';
                                },
                                error: function () {
