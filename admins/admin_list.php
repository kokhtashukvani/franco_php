...
$sql = "SELECT id, first_name, last_name, username, email FROM admins";
    ...
    <div class="wrapper">
        ...
        <main class="col-md-10 ms-sm-auto content">
            <header class="d-flex justify-content-between align-items-center mb-3">
                <h5>مدیریت کاربران &gt; لیست کاربران</h5>
            ...
            <div class="card p-4 mt-3">
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <div class="btn-group">
                        <a href="admin_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> ایجاد جدید</a>
                    </div>
                    <div class="btn-group">
                    ...
                    <table id="crudTable" class="table table-bordered table-striped">
                        <thead class="table-header" style="background:#5986b3 !important">
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle">نام کاربری</th>
                                <th style="text-align:center; vertical-align:middle">ایمیل</th>
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr data-id="<?php echo $row['id']; ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-primary" href="admin_edit.php?id=<?php echo $row['id']; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="admin_delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این رکورد مطمئن هستید؟');">
