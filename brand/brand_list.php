...
$sql = "SELECT id, title, latin_title, logo_image, is_show, display_order FROM brands ORDER BY display_order ASC";
        ...
        <main class="col-md-10 ms-sm-auto content">
            ...
            <div class="card p-4 mt-3">
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <div class="btn-group">
                        <a class="btn btn-primary" href="brand_add.php"><i class="fa fa-plus"></i> ایجاد جدید</a>
                    </div>
                    ...
                    <table id="crudTable" class="table table-bordered table-striped">
                        <thead class="table-header" style="background:#5986b3 !important">
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle">تصویر لوگو برند</th>
                                <th style="text-align:center; vertical-align:middle">عنوان</th>
                                <th style="text-align:center; vertical-align:middle">عنوان لاتین</th>
                        ...
                        <tbody>
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr data-id="<?php echo $row['id']; ?>">
                                        ...
                                        <td class="text-center">
                                            <img src="<?php echo htmlspecialchars($row['logo_image']); ?>" alt="Image" style="max-width: 80px; max-height: 80px;">
                                        </td>
                                        <td class="text-center"><?php echo htmlspecialchars($row['title']); ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($row['latin_title']); ?></td>
                                        <td class="text-center">
                                            <?php if ($row['is_show']): ?>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-primary" href="brand_edit.php?id=<?php echo $row['id']; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="brand_delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این رکورد مطمئن هستید؟');">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center">هیچ برندی یافت نشد.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
