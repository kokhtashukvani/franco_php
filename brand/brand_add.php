    ...
    <div class="wrapper">
        ...
        <main class="col-md-10 ms-sm-auto content">
            ...
            <div class="card p-4 mt-3">
                <form action="brand_create.php" class="card-body" enctype="multipart/form-data" method="post">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="latin_title" name="latin_title" type="text" value="">
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-check">
                                <input class="form-check-input" id="is_show" name="is_show" type="checkbox" value="1" checked>
