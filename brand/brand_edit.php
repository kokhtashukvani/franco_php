...
$stmt = $conn->prepare("SELECT title, latin_title, logo_image, is_show FROM brands WHERE id = ?");
...
<body>
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="brand_list.php"><i class="fa fa-bullhorn"></i> برند</a>
        ...
        <main class="col-md-10 ms-sm-auto content">
            ...
            <div class="card p-4 mt-3">
                <form action="brand_update.php" class="card-body" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="form-label" for="title">عنوان</label>
                                <input class="form-control" id="title" name="title" type="text" value="<?php echo htmlspecialchars($brand['title']); ?>">
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                                <label class="form-label" for="latin_title">عنوان لاتین</label>
                                <input class="form-control" id="latin_title" name="latin_title" type="text" value="<?php echo htmlspecialchars($brand['latin_title']); ?>">
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                                <label class="form-label" for="logo_image">تصویر لوگو برند</label>
                                <input type="file" name="logo_image" id="logo_image" class="form-control" accept="image/*">
                                <img src="<?php echo htmlspecialchars($brand['logo_image']); ?>" alt="Image" style="max-width: 80px; max-height: 80px; margin-top: 10px;">
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group form-check">
                                <input class="form-check-input" id="is_show" name="is_show" type="checkbox" value="1" <?php echo $brand['is_show'] ? 'checked' : ''; ?>>
                                <label class="form-label" for="is_show">نمایش/عدم نمایش</label>
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> ثبت</button>
                                &nbsp;&nbsp;
                                <a href="brand_list.php" class="btn btn-warning">
